...
est = dict(rank=7,
           ...
           predict="poisso_p",
           cmd="poisson",
           cmdline="poisson sexecutions sincome sperpoverty "
                     "sperblack LN_VC100k96 south sdegree")
...
est = dict(alpha=1.1399915663048,
           rank=8,
           N=17,
           ic=6,
           k=8,
           ...
           predict="nbreg_p",
           cmd="nbreg",
           cmdline="nbreg sexecutions sincome sperpoverty sperblack "
...
margins_cov = np.array([
    ...
    -.34297224102579, -.61952491151176, .88600743091011,
    .71851239110057]).reshape(8, 8)

margins_cov_colnames = ('sincome sperpoverty sperblack LN_VC100k96 '
                        'south sdegree _cons _cons'.split())
...
est = dict(rank=7,
           ...
           cmd="poisson",
           cmdline="poisson sexecutions sincome sperpoverty "
                     "sperblack LN_VC100k96 i.south sdegree")
...
margins_table_rownames = ('sincome sperpoverty sperblack LN_VC100k96 '
                          '0b.south 1.south sdegree'.split())
...
margins_cov = np.array([
    ...
    0, 1.4619977752889, -4.4615412084808, 37.559994394343]).reshape(8, 8)

margins_cov_colnames = ('sincome sperpoverty sperblack LN_VC100k96 '
                        '0b.south 1.south sdegree _cons'.split())
...
est = dict(alpha=1.139991566304804,
           rank=8,
           N=17,
           ic=6,
           k=9,
...
margins_cov_colnames = ('sincome sperpoverty sperblack LN_VC100k96 '
                        '0b.south 1.south sdegree _cons _cons'.split())
