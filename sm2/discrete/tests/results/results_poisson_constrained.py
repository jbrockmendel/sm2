...
params_table = np.array([
    ...
    7.088958545805, np.nan, 1.9599639845401, 0]).reshape(8, 9)
...
params_table = np.array([
    ...
    -1.476233315779, np.nan, 1.9599639845401, 0]).reshape(8, 9)
...
params_table = np.array([
    ...
    -6.9803041169553, np.nan, 1.9599639845401, 0]).reshape(8, 9)
