...
cov = np.array([
    ...
    .02015715724983, -.00714955450361, -.09288283512096,
    .05054897861465]).reshape(4, 4)
...
cov = np.array([
    ...
    .02098165591138, -.02643483668568, -.03915049342584,
    .05762736490753]).reshape(4, 4)
...
cov = np.array([
    ...
    .00045725833006, -.00926008351523, .02198323898312,
    .26322927930229]).reshape(4, 4)
...
cov = np.array([
    ...
    -.07133030733881, -.09492663454187, .43276143586693,
    .74959931564018]).reshape(4, 4)
