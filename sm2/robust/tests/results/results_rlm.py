...
class Huber(object):
    def __init__(self):
        ...
        self.df_model = 3
        self.df_resid = 17
        self.bcov_unscaled = np.array([  # From R
...
class Hampel(object):
    def __init__(self):
        ...
        self.bcov_unscaled = np.array([
            ...
            [2.73387119e-02, -6.19611175e-02, -1.59355028e-01, 1.34527267e+01]])
        self.fittedvalues = np.array([
            38.93732292, 39.08284798, 32.63622398, 22.21364028,
...
class BiSquare(object):
    def __init__(self):
        ...
        self.bcov_unscaled = np.array([
            ...
            [2.73387119e-02, -6.19611175e-02, -1.59355028e-01, 1.34527267e+01]])
        self.fittedvalues = np.array([
            39.49082198, 39.60315301, 33.43929104, 21.06743967,
            ...
            8.36817892, 7.5818617, 8.12026288, 13.46088339, 25.43556344])
