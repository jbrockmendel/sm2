    ...
    **Attributes**
    ...
    def resid_pearson(self):
        ...
        if np.sqrt(self.scale) < 10 * eps * self.model.endog.mean():
            ...
            warnings.warn("All residuals are 0, cannot compute normed residuals.",
                          RuntimeWarning)
            return self.wresid
        else:
...
class OLSResults(RegressionResults):
    ...
    def get_influence(self):
        ...
        """
        from sm2.stats.outliers_influence import OLSInfluence
    ...
    def outlier_test(self, method='bonf', alpha=.05):
        ...
        df = df_resid - 1.
        """
        from sm2.stats.outliers_influence import outlier_test
