...
vcov_ml_drf_3 = np.array([0.01398831, 0.001592619,
                          0.001592619, 0.01602274]).reshape(2, 2, order='F')
...
vcov_reml_drf_3 = np.array([0.01411922, 0.001607343,
                            0.001607343, 0.01617574]).reshape(2, 2, order='F')
...
vcov_reml_drf_4 = np.array([0.001206925, -5.4182e-05,
                            6.073475e-05, -5.4182e-05,
                            0.001479871, -2.723494e-05,
                            6.073475e-05, -2.723494e-05,
...
vcov_ml_drf_5 = np.array([0.01677563, 0.0008077524,
                          -0.001255011, 0.0008077524,
                          0.01719346, 0.0009266736,
                          -0.001255011, 0.0009266736,
...
vcov_reml_drf_5 = np.array([0.0169698, 0.0008162714,
                            -0.001268635, 0.0008162714,
                            0.01739219, 0.0009345538,
                            -0.001268635, 0.0009345538,
...
cov_re_ml_irf_7 = np.array([0.2021561, 0,
                            0, 3.270735]).reshape(2, 2, order='F')
...
cov_re_reml_irf_7 = np.array([0.2026938, 0,
                              0, 3.273129]).reshape(2, 2, order='F')
...
cov_re_ml_drf_8 = np.array([0.1506188, 0.126091,
                            0.126091, 2.485462]).reshape(2, 2, order='F')
...
cov_re_ml_irf_8 = np.array([0.1498568, 0,
                            0, 2.403849]).reshape(2, 2, order='F')
...
vcov_ml_drf_9 = np.array([0.02208544, 0.001527479,
                          0.001527479, 0.02597528]).reshape(2, 2, order='F')

cov_re_ml_drf_9 = np.array([0.510175, 0.08826114,
                            0.08826114, 3.342888]).reshape(2, 2, order='F')
...
vcov_reml_drf_9 = np.array([0.02228589, 0.001535598,
                            0.001535598, 0.0262125]).reshape(2, 2, order='F')

cov_re_reml_drf_9 = np.array([0.5123204, 0.08897376,
                              0.08897376, 3.341722]).reshape(2, 2, order='F')
...
vcov_ml_irf_9 = np.array([0.02205706, 0.001509887,
                          0.001509887, 0.02599941]).reshape(2, 2, order='F')

cov_re_ml_irf_9 = np.array([0.5086816, 0,
                            0, 3.312757]).reshape(2, 2, order='F')
...
vcov_reml_irf_9 = np.array([0.02225705, 0.001517774,
                            0.001517774, 0.02623682]).reshape(2, 2, order='F')

cov_re_reml_irf_9 = np.array([0.5107725, 0,
                              0, 3.31152]).reshape(2, 2, order='F')
...
cov_re_reml_irf_10 = np.array([0.2026653, 0,
                               0, 2.193124]).reshape(2, 2, order='F')
...
vcov_reml_drf_11 = np.array([0.02351795, 0.001749756,
                             0.002301599, 0.001749756,
                             0.02346869, 0.0004785668,
                             0.002301599, 0.0004785668,
                             0.02149093]).reshape(3, 3, order='F')

cov_re_reml_drf_11 = np.array([0.3680346, 0.3324419,
                               0.3324419, 1.118623]).reshape(2, 2, order='F')
...
vcov_ml_irf_11 = np.array([0.02319951, 0.001705996,
                           0.002265252, 0.001705996,
                           0.02345623, 0.000514879,
                           0.002265252, 0.000514879,
                           0.02153162]).reshape(3, 3, order='F')

cov_re_ml_irf_11 = np.array([0.4004789, 0,
                             0, 1.108087]).reshape(2, 2, order='F')
