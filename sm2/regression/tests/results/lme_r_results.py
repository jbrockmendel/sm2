...
vcov_ml_drf_0 = np.array([0.001317148]).reshape(1, 1)

cov_re_ml_drf_0 = np.array([0.2522485]).reshape(1, 1)
...
vcov_reml_drf_0 = np.array([0.001323559]).reshape(1, 1)

cov_re_reml_drf_0 = np.array([0.2524129]).reshape(1, 1)
...
vcov_ml_drf_1 = np.array([0.01340632]).reshape(1, 1)

cov_re_ml_drf_1 = np.array([0]).reshape(1, 1)
...
vcov_reml_drf_1 = np.array([0.01345931]).reshape(1, 1)

cov_re_reml_drf_1 = np.array([2.839777e-14]).reshape(1, 1)
...
vcov_ml_drf_2 = np.array([0.00117849, 1.458744e-05,
                          1.458744e-05, 0.001054926]).reshape(2, 2)

cov_re_ml_drf_2 = np.array([0.1596058]).reshape(1, 1)
...
vcov_reml_drf_2 = np.array([0.001190455, 1.482666e-05,
                            1.482666e-05, 0.001066002]).reshape(2, 2)

cov_re_reml_drf_2 = np.array([0.1595015]).reshape(1, 1)
...
vcov_ml_drf_3 = np.array([0.01398831, 0.001592619,
                          0.001592619, 0.01602274]).reshape(2, 2)

cov_re_ml_drf_3 = np.array([0.8130996]).reshape(1, 1)
...
vcov_reml_drf_3 = np.array([0.01411922, 0.001607343,
                            0.001607343, 0.01617574]).reshape(2, 2)

cov_re_reml_drf_3 = np.array([0.8117898]).reshape(1, 1)
...
cov_re_ml_drf_4 = np.array([0.1703249]).reshape(1, 1)
...
vcov_reml_drf_4 = np.array([[0.001206925, -5.4182e-05, 6.073475e-05],
                            [-5.4182e-05, 0.001479871, -2.723494e-05],
                            [6.073475e-05, -2.723494e-05, 0.001506198]])

cov_re_reml_drf_4 = np.array([0.1705659]).reshape(1, 1)
...
vcov_ml_drf_5 = np.array([[0.01677563, 0.0008077524, -0.001255011],
                          [0.0008077524, 0.01719346, 0.0009266736],
                          [-0.001255011, 0.0009266736, 0.01608435]])

cov_re_ml_drf_5 = np.array([0.3444677]).reshape(1, 1)
...
vcov_reml_drf_5 = np.array([[0.0169698, 0.0008162714, -0.001268635],
                            [0.0008162714, 0.01739219, 0.0009345538],
                            [-0.001268635, 0.0009345538, 0.01627074]])

cov_re_reml_drf_5 = np.array([0.3420993]).reshape(1, 1)
...
vcov_ml_drf_6 = np.array([0.002443738]).reshape(1, 1)

cov_re_ml_drf_6 = np.array([0.2595201, 0.04591071,
                            0.04591071, 2.204612]).reshape(2, 2)
...
ranef_condvar_ml_drf_6 = np.array([0.2420741, 0.2222169,
                                   0.2222169, 0.4228908]).reshape(2, 2)

coef_reml_drf_6 = np.array([-0.8883881])

vcov_reml_drf_6 = np.array([0.002461581]).reshape(1, 1)

cov_re_reml_drf_6 = np.array([0.2595767, 0.04590012,
                              0.04590012, 2.204822]).reshape(2, 2)
...
ranef_condvar_reml_drf_6 = np.array([0.2421365, 0.2221108,
                                     0.2221108, 0.4244443]).reshape(2, 2)

coef_ml_irf_6 = np.array([-0.8874992])

vcov_ml_irf_6 = np.array([0.002445505]).reshape(1, 1)

cov_re_ml_irf_6 = np.array([0.2587624, 0,
                            0, 2.188653]).reshape(2, 2)
...
vcov_reml_irf_6 = np.array([0.002463375]).reshape(1, 1)

cov_re_reml_irf_6 = np.array([0.2588157, 0,
                              0, 2.188876]).reshape(2, 2)
...
vcov_ml_drf_7 = np.array([0.01994]).reshape(1, 1)

cov_re_ml_drf_7 = np.array([0.2051329, 0.0734377,
                            0.0734377, 3.285381]).reshape(2, 2)
...
ranef_condvar_ml_drf_7 = np.array([0.1823183, 0.02247519,
                                   0.02247519, 1.125011]).reshape(2, 2)

coef_reml_drf_7 = np.array([-0.9647862])

vcov_reml_drf_7 = np.array([0.02002546]).reshape(1, 1)

cov_re_reml_drf_7 = np.array([0.2056226, 0.0726139,
                              0.0726139, 3.2876]).reshape(2, 2)
...
ranef_condvar_reml_drf_7 = np.array([0.1828266, 0.02229138,
                                     0.02229138, 1.128947]).reshape(2, 2)

coef_ml_irf_7 = np.array([-0.9665524])

vcov_ml_irf_7 = np.array([0.01998144]).reshape(1, 1)

cov_re_ml_irf_7 = np.array([0.2021561, 0,
                            0, 3.270735]).reshape(2, 2)
...
vcov_reml_irf_7 = np.array([0.02006657]).reshape(1, 1)

cov_re_reml_irf_7 = np.array([0.2026938, 0,
                              0, 3.273129]).reshape(2, 2)
...
vcov_ml_drf_8 = np.array([0.002491643, 0.0001693531,
                          0.0001693531, 0.00253309]).reshape(2, 2)

cov_re_ml_drf_8 = np.array([0.1506188, 0.126091,
                            0.126091, 2.485462]).reshape(2, 2)
...
ranef_condvar_ml_drf_8 = np.array([0.05400391, 0.002330104,
                                   0.002330104, 0.122761]).reshape(2, 2)

coef_reml_drf_8 = np.array([-1.083938, 0.8956893])

vcov_reml_drf_8 = np.array([0.002528969, 0.0001712206,
                            0.0001712206, 0.002573335]).reshape(2, 2)

cov_re_reml_drf_8 = np.array([0.1505098, 0.1256311,
                              0.1256311, 2.484219]).reshape(2, 2)
...
ranef_condvar_reml_drf_8 = np.array([0.05463632, 0.002393538,
                                     0.002393538, 0.1249828]).reshape(2, 2)

coef_ml_irf_8 = np.array([-1.079481, 0.898216])

vcov_ml_irf_8 = np.array([0.002511536, 0.0001812511,
                          0.0001812511, 0.002573405]).reshape(2, 2)

cov_re_ml_irf_8 = np.array([0.1498568, 0,
                            0, 2.403849]).reshape(2, 2)
...
vcov_reml_irf_8 = np.array([0.002549354, 0.0001833386,
                            0.0001833386, 0.002614672]).reshape(2, 2)

cov_re_reml_irf_8 = np.array([0.1497193, 0,
                              0, 2.403076]).reshape(2, 2)
...
vcov_ml_drf_9 = np.array([0.02208544, 0.001527479,
                          0.001527479, 0.02597528]).reshape(2, 2)

cov_re_ml_drf_9 = np.array([0.510175, 0.08826114,
                            0.08826114, 3.342888]).reshape(2, 2)
...
ranef_condvar_ml_drf_9 = np.array([0.3994872, 0.02478884,
                                   0.02478884, 1.195077]).reshape(2, 2)

coef_reml_drf_9 = np.array([-1.272483, 0.861814])

vcov_reml_drf_9 = np.array([0.02228589, 0.001535598,
                            0.001535598, 0.0262125]).reshape(2, 2)

cov_re_reml_drf_9 = np.array([0.5123204, 0.08897376,
                              0.08897376, 3.341722]).reshape(2, 2)
...
ranef_condvar_reml_drf_9 = np.array([0.401762, 0.02521271,
                                     0.02521271, 1.203536]).reshape(2, 2)

coef_ml_irf_9 = np.array([-1.277018, 0.86395])

vcov_ml_irf_9 = np.array([0.02205706, 0.001509887,
                          0.001509887, 0.02599941]).reshape(2, 2)

cov_re_ml_irf_9 = np.array([0.5086816, 0,
                            0, 3.312757]).reshape(2, 2)
...
vcov_reml_irf_9 = np.array([0.02225705, 0.001517774,
                            0.001517774, 0.02623682]).reshape(2, 2)

cov_re_reml_irf_9 = np.array([0.5107725, 0,
                              0, 3.31152]).reshape(2, 2)
...
cov_re_ml_drf_10 = np.array([0.2040541, 0.09038325,
                             0.09038325, 2.218903]).reshape(2, 2)
...
ranef_condvar_ml_drf_10 = np.array([0.1988816, 0.1872403,
                                    0.1872403, 0.4052274]).reshape(2, 2)
...
cov_re_reml_drf_10 = np.array([0.2034827, 0.09063836,
                               0.09063836, 2.219191]).reshape(2, 2)
...
ranef_condvar_reml_drf_10 = np.array([0.1983981, 0.1865469,
                                      0.1865469, 0.4100937]).reshape(2, 2)
...
ranef_condvar_ml_drf_11 = np.array([0.2987928, 0.1992074,
                                    0.1992074, 0.7477486]).reshape(2, 2)

coef_reml_drf_11 = np.array([-1.370236, 0.1597671, 0.8585994])

vcov_reml_drf_11 = np.array([[0.02351795, 0.001749756, 0.002301599],
                             [0.001749756, 0.02346869, 0.0004785668],
                             [0.002301599, 0.0004785668, 0.02149093]])

cov_re_reml_drf_11 = np.array([0.3680346, 0.3324419,
                               0.3324419, 1.118623]).reshape(2, 2)
...
ranef_condvar_reml_drf_11 = np.array([0.2965372, 0.2010191,
                                      0.2010191, 0.7503986]).reshape(2, 2)

coef_ml_irf_11 = np.array([-1.370117, 0.1414964, 0.8466083])

vcov_ml_irf_11 = np.array([[0.02319951, 0.001705996, 0.002265252],
                           [0.001705996, 0.02345623, 0.000514879],
                           [0.002265252, 0.000514879, 0.02153162]])

cov_re_ml_irf_11 = np.array([0.4004789, 0,
                             0, 1.108087]).reshape(2, 2)
