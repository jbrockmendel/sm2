...
params_table_colnames = ['b', 'se', 't', 'pvalue',
                         'll', 'ul', 'df', 'crit', 'eform']

params_table_rownames = ['lincome', 'lprice', '_cons']

cov = np.array([[.01068933438529, -.00081953185523, -.0199747086722],
                [-.00081953185523, .00122255079374, -.00064024357954],
                [-.0199747086722, -.00064024357954, .04140330733319]])

cov_colnames = ['lincome', 'lprice', '_cons']

cov_rownames = ['lincome', 'lprice', '_cons']

cov_prior = np.array([.0225, -.01, 0, -.01,
                      .0225, 0, 0, 0, 0]).reshape(3, 3)

cov_prior_colnames = ['lincome', 'lprice', '_cons']

cov_prior_rownames = ['lincome', 'lprice', '_cons']
...
results_theil_textile = Bunch(
    ...
    cmdline="tgmixed lconsump lincome lprice, "
