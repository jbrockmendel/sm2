...
from sm2.tools.sm_exceptions import ValueWarning, EstimationWarning
...
class PCA(object):
    ...
    def _compute_using_nipals(self):
        """
        NIPALS implementation to compute small number of eigenvalues and
        eigenvectors
        """
        x = self.transformed_data
        if self._ncomp > 1:
    ...
    def _compute_rsquare_and_ic(self):
        ...
        # TODO: This needs careful testing, with and without weights, gls,
        # standardized and demean
...
def pca(data, ncomp=None, standardize=True, demean=True, normalize=True,
    ...
    Notes
    -----
    This is a simple function wrapper around the PCA class. See PCA for more
    information and additional methods.
    """
