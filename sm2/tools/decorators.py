...
class ResettableCache(dict):
    ...
    def __delitem__(self, key):  # TODO: not hit in tests
...
class CachedAttribute(object):
    ...
    def __get__(self, obj, type=None):
        if obj is None:
            return self.fget  # TODO: not hit in tests
        ...
        # TODO: Use a sentinel in case the actual answer is `None`
        ...
        if _cachedval is None:
            ...
            try:
                ...
                # TODO: not hit in tests.  Also: what?
