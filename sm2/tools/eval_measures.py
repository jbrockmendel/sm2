...
def stde(x1, x2, ddof=0, axis=0):  # pragma: no cover
    raise NotImplementedError("stde (standard deviation of error) is "
                              "not ported from upstream, as it is neither "
                              "used or tested there.")
