        ...
        if isinstance(retvals, dict):
            ...
            if warn_convergence and not retvals['converged']:
                ...
                warnings.warn("Maximum Likelihood optimization failed to "
                              "converge. Check mle_retvals", ConvergenceWarning)
...
class Results(object):
    ...
    def __init__(self, model, params, **kwargs):
        self.__dict__.update(kwargs)  # TODO: GROSS! DONT DO THIS
    ...
    def initialize(self, model, params, **kwargs):
        self.params = params
        self.model = model
        if hasattr(model, 'k_constant'):  # TODO: Set this unconditionally!
    ...
    def predict(self, exog=None, transform=True, *args, **kwargs):
        ...
        """
        exog_index = exog.index if is_using_pandas(exog, None) else None
...
#   ResultsWrapper already inherits it?  Any Reason not to inherit in Results?
class LikelihoodModelResults(Results, wrap.SaveLoadMixin):
    ...
    **Attributes**
    ...
    def __init__(self, model, params, normalized_cov_params=None, scale=1.,
        ...
        if 'cov_type' in kwargs:
            ...
            if cov_type == 'nonrobust':
                ...
                self.cov_kwds = {'description': 'Standard Errors assume '
                                 'that the covariance matrix of the errors '
    ...
    def t_test(self, r_matrix, cov_p=None, scale=None, use_t=None):
        ...
        >>> from sm2.formula.api import ols
    ...
    def wald_test_terms(self, skip_single=False, extra_constraints=None,
        ...
        res_wald = []
        index = []
        all_constraints = constraints + combined_constraints + extra_constraints
        for name, constraint in all_constraints:
