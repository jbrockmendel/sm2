...
from six import next, integer_types
    ...
    *rectangular* (2d!) array of data, not necessarily numerical.
    ...
    def _get_colwidths(self, output_format, **fmt_dict):
        ...
        if request is 0:  # assume no extra space desired (e.g, CSV)
            ...
            request = [0] * ncols
        elif isinstance(request, integer_types):
...
class Cell(object):
    ...
    def alignment(self, output_format, **fmt_dict):
        ...
        if isinstance(datatype, integer_types):
