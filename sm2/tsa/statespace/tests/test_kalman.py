...
from sm2.tsa.statespace.sarimax import SARIMAX
from sm2.tsa.statespace import _statespace as ss
...
class Clark1987(object):
    ...
    @pytest.mark.skipif(NP_LT_18, reason='Array order is not preserved on Numpy <= 1.8')
