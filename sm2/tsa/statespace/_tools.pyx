...
cdef int _ssolve_discrete_lyapunov(
    ...
    # u = v.conj()
    lapack.sgees(
        "V", "N", <lapack.sselect2 *> &_sselect2, &n,
        a, &n,
        &sdim,
        &wr[0], &wi[0],
        &u[0, 0], &n,
...
cpdef _scompute_coefficients_from_multivariate_pacf(
        np.float32_t [::1,:] partial_autocorrelations,
...
cpdef int sreorder_missing_matrix(
        np.float32_t [::1, :, :] A, int [::1, :] missing,
...
cpdef int sreorder_missing_vector(
        np.float32_t [::1, :] A, int [::1, :] missing) except *:
    cdef:
        int i, k, t, n, T, nobs
...
cdef int _scopy_missing_diagonal(
        np.float32_t * a, np.float32_t * b, int * missing, int n):
    """
...
cdef int _scopy_missing_rows(
        np.float32_t * a, np.float32_t * b, int * missing, int n, int m):
    """
    a is a pointer to an n x m array A
    b is a pointer to an n x n diagonal array B (copy to)
    missing is a pointer to an n x 1 array
...
cpdef int scopy_missing_matrix(
        np.float32_t [::1, :, :] A, np.float32_t [::1, :, :] B, int [::1, :] missing, int missing_rows, int missing_cols, int diagonal) except *:
    cdef:
...
cpdef int scopy_missing_vector(
        np.float32_t [::1, :] A, np.float32_t [::1, :] B, int [::1, :] missing) except *:
    cdef:
        int n, t, T, A_t = 0, A_T
...
cdef int _scopy_index_diagonal(
        np.float32_t * a, np.float32_t * b, int * index, int n):
    """
...
cdef int _scopy_index_rows(
        np.float32_t * a, np.float32_t * b, int * index, int n, int m):
    """
    a is a pointer to an n x m array A
    b is a pointer to an n x n diagonal array B (copy to)
    index is a pointer to an n x 1 array
...
cdef int _scopy_index_cols(
        np.float32_t * a, np.float32_t * b, int * index,
        int n, int m):
    """
    a is a pointer to an n x m array A
    b is a pointer to an n x n diagonal array B (copy to)
...
cpdef int scopy_index_matrix(
        np.float32_t [::1, :, :] A, np.float32_t [::1, :, :] B, int [::1, :] index,
...
cpdef int scopy_index_vector(
        np.float32_t [::1, :] A, np.float32_t [::1, :] B, int [::1, :] index) except *:
    cdef:
        int n, t, T, A_t = 0, A_T
...
cdef int _zsolve_discrete_lyapunov(
        np.complex128_t * a, np.complex128_t * q,
        int n, int complex_step=False) except *:
    # Note: some of this code (esp. the Sylvester solving part) cribbed from
    # https://raw.githubusercontent.com/scipy/scipy/master/scipy/linalg/_solvers.py
...
cpdef _zcompute_coefficients_from_multivariate_pacf(
        np.complex128_t [::1,:] partial_autocorrelations,
...
cpdef int zreorder_missing_matrix(
        np.complex128_t [::1, :, :] A, int [::1, :] missing,
        int reorder_rows, int reorder_cols, int diagonal) except *:
    cdef:
        int n, m, T, t
...
cpdef int zreorder_missing_vector(
        np.complex128_t [::1, :] A, int [::1, :] missing) except *:
    cdef:
        int i, k, t, n, T, nobs
...
cdef int _zcopy_missing_diagonal(
        np.complex128_t * a, np.complex128_t * b, int * missing, int n):
    """
    Copy the non-missing block of diagonal entries
...
cdef int _zcopy_missing_rows(
        np.complex128_t * a, np.complex128_t * b, int * missing, int n, int m):
    """
    a is a pointer to an n x m array A
    b is a pointer to an n x n diagonal array B (copy to)
    missing is a pointer to an n x 1 array
...
cpdef int zcopy_missing_matrix(
        np.complex128_t [::1, :, :] A, np.complex128_t [::1, :, :] B, int [::1, :] missing, int missing_rows, int missing_cols, int diagonal) except *:
    cdef:
        int n, m, T, t, A_T, A_t = 0, time_varying
...
cpdef int zcopy_missing_vector(
        np.complex128_t [::1, :] A, np.complex128_t [::1, :] B, int [::1, :] missing) except *:
    cdef:
        int n, t, T, A_t = 0, A_T
...
cdef int _zcopy_index_diagonal(
        np.complex128_t * a, np.complex128_t * b, int * index, int n):
    """
    Copy the non-index block of diagonal entries
...
cdef int _zcopy_index_rows(
        np.complex128_t * a, np.complex128_t * b, int * index, int n, int m):
    """
    a is a pointer to an n x m array A
    b is a pointer to an n x n diagonal array B (copy to)
    index is a pointer to an n x 1 array
...
cdef int _zcopy_index_cols(
        np.complex128_t * a, np.complex128_t * b, int * index,
        int n, int m):
    """
    a is a pointer to an n x m array A
    b is a pointer to an n x n diagonal array B (copy to)
...
cpdef int zcopy_index_matrix(
        np.complex128_t [::1, :, :] A, np.complex128_t [::1, :, :] B, int [::1, :] index,
        int index_rows, int index_cols, int diagonal) except *:
    cdef:
        int n, m, T, t, A_T, A_t = 0, time_varying
...
cpdef int zcopy_index_vector(
        np.complex128_t [::1, :] A, np.complex128_t [::1, :] B, int [::1, :] index) except *:
    cdef:
        int n, t, T, A_t = 0, A_T
...
cdef int _dsolve_discrete_lyapunov(
    ...
    # u = v.conj()
    lapack.dgees(
        "V", "N", <lapack.dselect2 *> &_dselect2, &n,
        a, &n,
        &sdim,
        &wr[0], &wi[0],
        &u[0, 0], &n,
...
cpdef _dcompute_coefficients_from_multivariate_pacf(
        np.float64_t [::1,:] partial_autocorrelations,
...
cpdef int dreorder_missing_matrix(
        np.float64_t [::1, :, :] A, int [::1, :] missing,
        int reorder_rows, int reorder_cols, int diagonal) except *:
    cdef:
        int n, m, T, t
...
cpdef int dreorder_missing_vector(
        np.float64_t [::1, :] A, int [::1, :] missing) except *:
    cdef:
        int i, k, t, n, T, nobs
...
cdef int _dcopy_missing_diagonal(
        np.float64_t * a, np.float64_t * b, int * missing, int n):
    """
    Copy the non-missing block of diagonal entries
...
cdef int _dcopy_missing_rows(
        np.float64_t * a, np.float64_t * b, int * missing, int n, int m):
    """
    a is a pointer to an n x m array A
    b is a pointer to an n x n diagonal array B (copy to)
    missing is a pointer to an n x 1 array
...
cpdef int dcopy_missing_matrix(
        np.float64_t [::1, :, :] A, np.float64_t [::1, :, :] B, int [::1, :] missing, int missing_rows, int missing_cols, int diagonal) except *:
    cdef:
        int n, m, T, t, A_T, A_t = 0, time_varying
...
cpdef int dcopy_missing_vector(
        np.float64_t [::1, :] A, np.float64_t [::1, :] B, int [::1, :] missing) except *:
    cdef:
        int n, t, T, A_t = 0, A_T
...
cdef int _dcopy_index_diagonal(
        np.float64_t * a, np.float64_t * b, int * index, int n):
    """
    Copy the non-index block of diagonal entries
...
cdef int _dcopy_index_rows(
        np.float64_t * a, np.float64_t * b, int * index, int n, int m):
    """
    a is a pointer to an n x m array A
    b is a pointer to an n x n diagonal array B (copy to)
    index is a pointer to an n x 1 array
...
cdef int _dcopy_index_cols(
        np.float64_t * a, np.float64_t * b, int * index,
        int n, int m):
    """
    a is a pointer to an n x m array A
    b is a pointer to an n x n diagonal array B (copy to)
...
cpdef int dcopy_index_matrix(
        np.float64_t [::1, :, :] A, np.float64_t [::1, :, :] B, int [::1, :] index,
        int index_rows, int index_cols, int diagonal) except *:
    cdef:
        int n, m, T, t, A_T, A_t = 0, time_varying
...
cpdef int dcopy_index_vector(
        np.float64_t [::1, :] A, np.float64_t [::1, :] B, int [::1, :] index) except *:
    cdef:
        int n, t, T, A_t = 0, A_T
...
cdef int _csolve_discrete_lyapunov(
        np.complex64_t * a, np.complex64_t * q,
        int n, int complex_step=False) except *:
    # Note: some of this code (esp. the Sylvester solving part) cribbed from
    # https://raw.githubusercontent.com/scipy/scipy/master/scipy/linalg/_solvers.py
...
cpdef _ccompute_coefficients_from_multivariate_pacf(
        np.complex64_t [::1,:] partial_autocorrelations,
...
cpdef int creorder_missing_matrix(
        np.complex64_t [::1, :, :] A, int [::1, :] missing,
        int reorder_rows, int reorder_cols, int diagonal) except *:
    cdef:
        int n, m, T, t
...
cpdef int creorder_missing_vector(
        np.complex64_t [::1, :] A, int [::1, :] missing) except *:
    cdef:
        int i, k, t, n, T, nobs
...
cdef int _ccopy_missing_diagonal(
        np.complex64_t * a, np.complex64_t * b, int * missing, int n):
    """
    Copy the non-missing block of diagonal entries
...
cdef int _ccopy_missing_rows(
        np.complex64_t * a, np.complex64_t * b, int * missing, int n, int m):
    """
    a is a pointer to an n x m array A
    b is a pointer to an n x n diagonal array B (copy to)
    missing is a pointer to an n x 1 array
...
cpdef int ccopy_missing_matrix(
        np.complex64_t [::1, :, :] A, np.complex64_t [::1, :, :] B, int [::1, :] missing, int missing_rows, int missing_cols, int diagonal) except *:
    cdef:
        int n, m, T, t, A_T, A_t = 0, time_varying
...
cpdef int ccopy_missing_vector(
        np.complex64_t [::1, :] A, np.complex64_t [::1, :] B, int [::1, :] missing) except *:
    cdef:
        int n, t, T, A_t = 0, A_T
...
cdef int _ccopy_index_diagonal(
        np.complex64_t * a, np.complex64_t * b, int * index, int n):
    """
    Copy the non-index block of diagonal entries
...
cdef int _ccopy_index_rows(
        np.complex64_t * a, np.complex64_t * b, int * index, int n, int m):
    """
    a is a pointer to an n x m array A
    b is a pointer to an n x n diagonal array B (copy to)
    index is a pointer to an n x 1 array
...
cdef int _ccopy_index_cols(
        np.complex64_t * a, np.complex64_t * b, int * index,
        int n, int m):
    """
    a is a pointer to an n x m array A
    b is a pointer to an n x n diagonal array B (copy to)
...
cpdef int ccopy_index_matrix(
        np.complex64_t [::1, :, :] A, np.complex64_t [::1, :, :] B, int [::1, :] index,
        int index_rows, int index_cols, int diagonal) except *:
    cdef:
        int n, m, T, t, A_T, A_t = 0, time_varying
...
cpdef int ccopy_index_vector(
        np.complex64_t [::1, :] A, np.complex64_t [::1, :] B, int [::1, :] index) except *:
    cdef:
        int n, t, T, A_t = 0, A_T
