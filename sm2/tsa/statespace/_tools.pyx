...
# cpdef csolve_discrete_lyapunov(
#        cnp.complex64_t[::1, :] a, cnp.complex64_t[::1, :] q, int overwrite=False):
#     cdef:
#         int inc = 1
#         int n = a.shape[0]
#         int n2 = n**2
...
#         cnp.complex64_t * _q
#         cnp.npy_intp dim[2]
#         cnp.complex64_t [::1,:] a_copy, q_copy
    
#     if not overwrite:
#         dim[0] = n; dim[1] = n;
#         a_copy = cnp.PyArray_ZEROS(2, dim, cnp.NPY_COMPLEX64, FORTRAN)
#         _a = &a_copy[0,0]
#         blas.ccopy(&n2, &a[0,0], &inc, _a, &inc)

#         q_copy = cnp.PyArray_ZEROS(2, dim, cnp.NPY_COMPLEX64, FORTRAN)
#         _q = &q_copy[0,0]
...
# cpdef ssolve_discrete_lyapunov(
#        cnp.float32_t[::1, :] a, cnp.float32_t[::1, :] q, int overwrite=False):
#     cdef:
#         int inc = 1
#         int n = a.shape[0]
#         int n2 = n**2
...
#         cnp.float32_t * _q
#         cnp.npy_intp dim[2]
#         cnp.float32_t [::1,:] a_copy, q_copy
    
#     if not overwrite:
#         dim[0] = n; dim[1] = n;
#         a_copy = cnp.PyArray_ZEROS(2, dim, cnp.NPY_FLOAT32, FORTRAN)
#         _a = &a_copy[0,0]
#         blas.scopy(&n2, &a[0,0], &inc, _a, &inc)

#         q_copy = cnp.PyArray_ZEROS(2, dim, cnp.NPY_FLOAT32, FORTRAN)
#         _q = &q_copy[0,0]
...
# cpdef zsolve_discrete_lyapunov(
#        cnp.complex128_t[::1, :] a, cnp.complex128_t[::1, :] q, int overwrite=False):
#     cdef:
#         int inc = 1
#         int n = a.shape[0]
#         int n2 = n**2
...
#         cnp.complex128_t * _q
#         cnp.npy_intp dim[2]
#         cnp.complex128_t [::1,:] a_copy, q_copy
    
#     if not overwrite:
#         dim[0] = n; dim[1] = n;
#         a_copy = cnp.PyArray_ZEROS(2, dim, cnp.NPY_COMPLEX128, FORTRAN)
#         _a = &a_copy[0,0]
#         blas.zcopy(&n2, &a[0,0], &inc, _a, &inc)

#         q_copy = cnp.PyArray_ZEROS(2, dim, cnp.NPY_COMPLEX128, FORTRAN)
#         _q = &q_copy[0,0]
...
# cpdef dsolve_discrete_lyapunov(
#        cnp.float64_t[::1, :] a, cnp.float64_t[::1, :] q, int overwrite=False):
#     cdef:
#         int inc = 1
#         int n = a.shape[0]
#         int n2 = n**2
...
#         cnp.float64_t * _q
#         cnp.npy_intp dim[2]
#         cnp.float64_t [::1,:] a_copy, q_copy
    
#     if not overwrite:
#         dim[0] = n; dim[1] = n;
#         a_copy = cnp.PyArray_ZEROS(2, dim, cnp.NPY_FLOAT64, FORTRAN)
#         _a = &a_copy[0,0]
#         blas.dcopy(&n2, &a[0,0], &inc, _a, &inc)

#         q_copy = cnp.PyArray_ZEROS(2, dim, cnp.NPY_FLOAT64, FORTRAN)
#         _q = &q_copy[0,0]
