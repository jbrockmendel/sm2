...
yhat_mle = genfromtxt(open(current_path + "/yhat_exact_nc.csv", "rb"),
                      delimiter=",", skip_header=1, dtype=float)

yhat_css = genfromtxt(open(current_path + "/yhat_css_nc.csv", "rb"),
                      delimiter=",", skip_header=1, dtype=float)

yhatc_mle = genfromtxt(open(current_path + "/yhat_exact_c.csv", "rb"),
                       delimiter=",", skip_header=1, dtype=float)

yhatc_css = genfromtxt(open(current_path + "/yhat_css_c.csv", "rb"),
                       delimiter=",", skip_header=1, dtype=float)

resids_mle = genfromtxt(open(current_path + "/resids_exact_nc.csv", "rb"),
                        delimiter=",", skip_header=1, dtype=float)

resids_css = genfromtxt(open(current_path + "/resids_css_nc.csv", "rb"),
                        delimiter=",", skip_header=1, dtype=float)

residsc_mle = genfromtxt(open(current_path + "/resids_exact_c.csv", "rb"),
                         delimiter=",", skip_header=1, dtype=float)

residsc_css = genfromtxt(open(current_path + "/resids_css_c.csv", "rb"),
                         delimiter=",", skip_header=1, dtype=float)

forecast_results = genfromtxt(open(current_path + "/results_arma_forecasts.csv", "rb"),
                              names=True, delimiter=",", dtype=float)
