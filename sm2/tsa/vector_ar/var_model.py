...
from sm2.tools.sm_exceptions import OutputWarning
...
class VARProcess(wold.VARProcess):
    ...
    def plot_acorr(self, nlags=10, linewidth=8):  # TODO: belongs in wold?
        ...
        return plotting.plot_full_acorr(self.acorr(nlags=nlags),
                                        linewidth=linewidth)
    ...
    # "known VAR(p) process" definition in the docstring; maybe
    # call this VARXprocess?
    def __init__(self, coefs, coefs_exog, sigma_u, trend,
                 names=None, _params_info=None):
        ...
        # FIXME: _params_info is... special.  See GH#4538
        ...
        # FIXME: Does this block screw up with wold.VARProcess.__init__?
        if self.k_trend > 0:
            if coefs_exog.ndim == 2:
                intercept = coefs_exog[:, 0]
            else:
    ...
    def simulate_var(self, steps=None, offset=None, seed=None):
        ...
        """
        # TODO: improve docstring for offset; see GH#4538
        steps_ = None
        if offset is None:
        ...
        y = util.varsim(self.coefs, offset, self.sigma_u,
...
# TODO: Check that inheriting TimeSeriesModelResults (which upstream doesnt do)
# doesn't add attributes that shouldnt exist here
class VARResults(VARProcess, tsa_model.TimeSeriesModelResults):
    ...
    **Attributes**
    ...
    def df_model(self):
        ...
        # TODO: Should neqs be multiplying k_exog?
    ...
    def __init__(self, endog, endog_lagged, params, sigma_u, lag_order,
        ...
        # TODO: I'm not wild about setting self.k_exog like this here
        self.k_exog = self.coefs_exog.shape[1]
        self.k_exog_user = k_exog_user
        self.exog = exog
        # TODO: maybe change to params class, distinguish exog_all
        # versus exog_user see GH#4535
        _params_info = {'k_trend': k_trend,
                        'k_exog_user': k_exog_user,
                        'k_ar': lag_order}
        VARProcess.__init__(self, coefs, self.coefs_exog, sigma_u,
                            trend=trend, names=names, _params_info=_params_info)
    ...
    def _cov_alpha(self):
        ...
        """
        # drop exog
        return self.cov_params[self.k_exog * self.neqs:,
                               self.k_exog * self.neqs:]
    ...
    def forecast_cov(self, steps=1, method='mse'):  # TODO: update docstring
