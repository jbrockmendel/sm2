...
class Family(object):
    ...
    def _setlink(self, link):
        ...
        See sm2.genmod.generalized_linear_model.GLM for a list of
        ...
        # [<sm2.family.links.Log object at 0x9a4240c>,
        #  <sm2.family.links.Power object at 0x9a423ec>,
    ...
    def resid_anscombe(self, endog, mu, var_weights=1., scale=1.):
        ...
        See Also
        --------
        sm2.genmod.families.family.Family : `resid_anscombe` for the
...
class Poisson(Family):
    ...
    link : a link instance, optional
        ...
        links are log, identity, and sqrt. See sm2.families.links for
        more information.
    ...
    Poisson.variance : varfuncs instance
        ...
        sm2.genmod.families.varfuncs.mu
...
class Gaussian(Family):
    ...
    link : a link instance, optional
        ...
        See sm2.genmod.families.links for more information.
    ...
    Gaussian.variance : varfunc instance
        ``variance`` is an instance of
        sm2.genmod.families.varfuncs.constant
    ...
    variance = varfuncs.constant
    safe_links = links

    def __init__(self, link=None):
        if link is None:
            link = _links.identity()
...
class Gamma(Family):
    ...
    Gamma.variance : varfunc instance
        ``variance`` is an instance of
        sm2.genmod.family.varfuncs.mu_squared
    ...
    def resid_anscombe(self, endog, mu, var_weights=1., scale=1.):
        ...
        """
        resid = (endog**(1 / 3.) - mu**(1 / 3.)) / mu**(1 / 3.) / scale ** 0.5
        return 3 * np.sqrt(var_weights) * resid
...
class Binomial(Family):
    ...
    Binomial.variance : varfunc instance
        ``variance`` is an instance of
        sm2.genmod.families.varfuncs.binary
    ...
    """
    links = [_links.logit, _links.probit, _links.cauchy, _links.log,
             _links.cloglog, _links.identity]
    variance = varfuncs.binary
    # this is not used below in an effort to include n

    # Other safe links, e.g. cloglog and probit are subclasses
    safe_links = [_links.Logit, _links.CDFLink]
    ...
    def __init__(self, link=None):  # , n=1.):
        ...
        super(Binomial, self).__init__(link=link,
                                       variance=varfuncs.Binomial(n=self.n))
...
class InverseGaussian(Family):
    ...
    InverseGaussian.variance : varfunc instance
        ``variance`` is an instance of
        sm2.genmod.families.varfuncs.mu_cubed
...
class NegativeBinomial(Family):
    ...
    NegativeBinomial.variance : varfunc instance
        ``variance`` is an instance of
        sm2.genmod.families.varfuncs.nbinom
    ...
    """
    links = [_links.log, _links.cloglog, _links.identity,
             _links.nbinom, _links.Power]
    ...
    def __init__(self, link=None, alpha=1.):
        ...
        super(NegativeBinomial, self).__init__(
            link=link, variance=varfuncs.NegativeBinomial(alpha=self.alpha))
...
class Tweedie(Family):
    ...
    Tweedie.variance : varfunc instance
        ``variance`` is an instance of
        sm2.genmod.families.varfuncs.Power
    ...
    sm2.genmod.generalized_linear_model.GLM class.
    """
    links = [_links.log, _links.Power]
    variance = varfuncs.Power
    safe_links = [_links.log, _links.Power]
    ...
    def __init__(self, link=None, var_power=1.):
        ...
        super(Tweedie, self).__init__(
            link=link, variance=varfuncs.Power(power=var_power * 1.))
